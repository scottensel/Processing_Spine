...
scatter(actVoxelsSeg4(1:4,:), [randVec+X(1,1), randVec+X(2,1), randVec+X(3,1), randVec+X(4,1)], 20, 'k','o','filled'); 
scatter(actVoxelsSeg6(1:4,:), [randVec+X(1,2), randVec+X(2,2), randVec+X(3,2), randVec+X(4,2)], 20, 'k','o','filled'); 
randVec = (-1 + (1+1)*rand(3,1))/10;
scatter(actVoxelsSeg4(5:end,:), [randVec+X(1,1), randVec+X(2,1), randVec+X(3,1), randVec+X(4,1)], 20, 'k','x'); 
scatter(actVoxelsSeg6(5:end,:), [randVec+X(1,2), randVec+X(2,2), randVec+X(3,2), randVec+X(4,2)], 20, 'k','x'); 
...
randVec = (-1 + (1+1)*rand(4,1))/10;
scatter(zSeg4(1:4,:), [randVec+X(1,1), randVec+X(2,1), randVec+X(3,1), randVec+X(4,1)], 20, 'k','o','filled'); 
scatter(zSeg6(1:4,:), [randVec+X(1,2), randVec+X(2,2), randVec+X(3,2), randVec+X(4,2)], 20, 'k','o','filled'); 
randVec = (-1 + (1+1)*rand(3,1))/10;
scatter(zSeg4(5:end,:), [randVec+X(1,1), randVec+X(2,1), randVec+X(3,1), randVec+X(4,1)], 20, 'k','x'); 
scatter(zSeg6(5:end,:), [randVec+X(1,2), randVec+X(2,2), randVec+X(3,2), randVec+X(4,2)], 20, 'k','x'); 
set (gca,'YDir','reverse')
yticks(1:length(1:4)); yticklabels({'C4','C5','C6','C7'})
ylabel('Cervical level')
xlabel('Z-score');
...
randVec = (-1 + (1+1)*rand(4,1))/10;
scatter([randVec+X(1,1), randVec+X(2,1)], lrSeg4(1:4,:),  20, 'k','o','filled'); 
scatter([randVec+X(1,2), randVec+X(2,2)], dvSeg4(1:4,:),  20, 'k','o','filled'); 
randVec = (-1 + (1+1)*rand(3,1))/10;
scatter([randVec+X(1,1), randVec+X(2,1)], lrSeg4(5:end,:),  20, 'k','x'); 
scatter([randVec+X(1,2), randVec+X(2,2)], dvSeg4(5:end,:),  20, 'k','x'); 
xticks(1:length(1:2)); xticklabels({'LR','DV'})
...
randVec = (-1 + (1+1)*rand(4,1))/10;
scatter([randVec+X(1,1), randVec+X(2,1)], zlrSeg4(1:4,:),  20, 'k','o','filled'); 
scatter([randVec+X(1,2), randVec+X(2,2)], zdvSeg4(1:4,:),  20, 'k','o','filled'); 
randVec = (-1 + (1+1)*rand(3,1))/10;
scatter([randVec+X(1,1), randVec+X(2,1)], zlrSeg4(5:end,:),  20, 'k','x'); 
scatter([randVec+X(1,2), randVec+X(2,2)], zdvSeg4(5:end,:),  20, 'k','x');  
xticks(1:length(1:2)); xticklabels({'LR','DV'})
xlabel('Cervical Area')
ylabel('Active Voxels');
% title(sprintf('Average Z-Score 4 vs 6 Runs combined'));
