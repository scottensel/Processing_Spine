...
for i = 1:length(subName)
    ...
    for j = 1:4
        direc = fullfile('D:\SMA\MRI_data_upper_limb\Spine', subName{i}, 'func', ['func', num2str(j)]);
        disp(fullfile(direc, 'fmri_spine_moco_mean_tsnr_PAM50.nii'))

        try
            motionData = importdata(fullfile('D:\SMA\MRI_data_upper_limb\Spine', subName{i}, 'func', ['func', num2str(j)], 'moco_params.tsv'));
...
% gunzip('D:\SMA\MRI_data_upper_limb\Spine\template\PAM50_cervical_cord.nii.gz');
% [spineLevels, ~] = cbiReadNifti('D:\SMA\MRI_data_upper_limb\Spine\template\PAM50_cervical_cord.nii');
...
saveas(gcf, ['D:\SMA\MRI_data_upper_limb\Spine\analysis\', subName{1}(1:5), '\Spine_tsnr.png']);
saveas(gcf, ['D:\SMA\MRI_data_upper_limb\Spine\analysis\', subName{1}(1:5), '\Spine_tsnr.svg']);
...
[spineLevels, ~] = cbiReadNifti('D:\SMA\MRI_data_upper_limb\Spine\template\PAM50_spinal_levels.nii');
% 
% gunzip(['D:\SMA\MRI_data_upper_limb\Spine\', subName{4}, '\anat\t2_spinal_levels_PAM50.nii.gz']);
% [spineLevels, ~] = cbiReadNifti(['D:\SMA\MRI_data_upper_limb\Spine\', subName{4}, '\anat\t2_spinal_levels_PAM50.nii']);

% if contains(subName{4}, 'SMA04')
% 
%     gunzip(['D:\SMA\MRI_data_upper_limb\Spine\', subName{4}, '\anat\t2_spinal_levels_PAM50.nii.gz']);
%     [spineLevels, ~] = cbiReadNifti(['D:\SMA\MRI_data_upper_limb\Spine\', subName{4}, '\anat\t2_spinal_levels_PAM50.nii']);
% 
% else
%     gunzip(['D:\SMA\MRI_data_upper_limb\Spine\', subName{1}, '\anat\t2_spinal_levels_PAM50.nii.gz']);
%     [spineLevels, ~] = cbiReadNifti(['D:\SMA\MRI_data_upper_limb\Spine\', subName{1}, '\anat\t2_spinal_levels_PAM50.nii']);
% 
% end
...
% gunzip('D:\SMA\MRI_data_upper_limb\Spine\template\PAM50_rl.nii.gz');
[lrLevels, ~] = cbiReadNifti('D:\SMA\MRI_data_upper_limb\Spine\template\PAM50_rl.nii');
% gunzip('D:\SMA\MRI_data_upper_limb\Spine\template\PAM50_dv.nii.gz');
[dvLevels, ~] = cbiReadNifti('D:\SMA\MRI_data_upper_limb\Spine\template\PAM50_dv.nii');
...
%     direc = fullfile('/Volumes/rnelshare/projects/human/brain_spine_stroke_SBSN/Data/sreya/Spine', subName{i}, 'func');
    direc = fullfile('D:\SMA\MRI_data_upper_limb\Spine', subName{i}, 'func');
...
title(sprintf('Average Active Pre vs Post'));
xticks(1:4)
xticklabels({'Pre 1','Pre 2','Post 1','Post 2'})

% Save the plot as a PNG image
saveas(gcf, ['D:\SMA\MRI_data_upper_limb\Spine\analysis\', subName{1}(1:5), '\Spine_voxel_success_z', num2str(zScore), '.png']);
saveas(gcf, ['D:\SMA\MRI_data_upper_limb\Spine\analysis\', subName{1}(1:5), '\Spine_voxel_success_z', num2str(zScore), '.svg']);
...
% Save the plot as a PNG image
% saveas(gcf, ['D:\SMA\MRI_data_upper_limb\Spine\analysis\', subName{1}(1:5), Spine_voxel_diff.png');
% saveas(gcf, ['D:\SMA\MRI_data_upper_limb\Spine\analysis\', subName{1}(1:5), Spine_voxel_diff.svg');
...
xlabel('Run Combination')
ylabel('Z-Score');
title(sprintf('Average Zscore Pre vs Post'));
xticks(1:4)
xticklabels({'Pre 1','Pre 2','Post 1','Post 2'})

% Save the plot as a PNG image
saveas(gcf, ['D:\SMA\MRI_data_upper_limb\Spine\analysis\', subName{1}(1:5), '\Spine_zscore_success_z', num2str(zScore), '.png']);
saveas(gcf, ['D:\SMA\MRI_data_upper_limb\Spine\analysis\', subName{1}(1:5), '\Spine_zscore_success_z', num2str(zScore), '.svg']);
...
% 
% % Save the plot as a PNG image
% saveas(gcf, ['D:\SMA\MRI_data_upper_limb\Spine\analysis\', subName{1}(1:5), Spine_zscore_diff.png');
% saveas(gcf, ['D:\SMA\MRI_data_upper_limb\Spine\analysis\', subName{1}(1:5), Spine_zscore_diff.svg');
...
% % Save the plot as a PNG image
% % saveas(gcf, ['D:\SMA\MRI_data_upper_limb\Spine\analysis\', subName{1}(1:5), Spine_voxel_slope.png');
% % saveas(gcf, ['D:\SMA\MRI_data_upper_limb\Spine\analysis\', subName{1}(1:5), Spine_voxel_slope.svg');
% 
% 
% 
% time = [1, 2, 3, 4, 5];
...
% xticklabels({'1-2','1-3','1-4','1-5','1-6'})
% Save the plot as a PNG image
% saveas(gcf, ['D:\SMA\MRI_data_upper_limb\Spine\analysis\', subName{1}(1:5), Spine_zscore_slope.png');
% saveas(gcf, ['D:\SMA\MRI_data_upper_limb\Spine\analysis\', subName{1}(1:5), Spine_zscore_slope.svg');
...
saveas(gcf, ['D:\SMA\MRI_data_upper_limb\Spine\analysis\', subName{1}(1:5), '\Spine_voxel_area_z', num2str(zScore), '.png']);
saveas(gcf, ['D:\SMA\MRI_data_upper_limb\Spine\analysis\', subName{1}(1:5), '\Spine_voxel_area_z', num2str(zScore), '.svg']);
...
randVec = (-1 + (1+1)*rand(2,1))/10;
scatter(zSeg4, [randVec+X(1,1), randVec+X(2,1), randVec+X(3,1), randVec+X(4,1)], 30, 'k','o','filled'); 
scatter(zSeg6, [randVec+X(1,2), randVec+X(2,2), randVec+X(3,2), randVec+X(4,2)], 30, 'k','o','filled'); 
set (gca,'YDir','reverse')
yticks(1:length(1:4)); yticklabels({'C5','C6','C7','C8'})
...
% Save the plot as a PNG imag
saveas(gcf, ['D:\SMA\MRI_data_upper_limb\Spine\analysis\', subName{1}(1:5), '\Spine_zscore_area_z', num2str(zScore), '.png']);
saveas(gcf, ['D:\SMA\MRI_data_upper_limb\Spine\analysis\', subName{1}(1:5), '\Spine_zscore_area_z', num2str(zScore), '.svg']);
...
xticks(1:4); xticklabels({'L(pre)', 'R(pre)', 'L(post)', 'R(post)'})
...
saveas(gcf, ['D:\SMA\MRI_data_upper_limb\Spine\analysis\', subName{1}(1:5), '\Spine_voxel_lr_z', num2str(zScore), '.png']);
saveas(gcf, ['D:\SMA\MRI_data_upper_limb\Spine\analysis\', subName{1}(1:5), '\Spine_voxel_lr_z', num2str(zScore), '.svg']);
...
saveas(gcf, ['D:\SMA\MRI_data_upper_limb\Spine\analysis\', subName{1}(1:5), '\Spine_voxel_dv_z', num2str(zScore), '.png']);
saveas(gcf, ['D:\SMA\MRI_data_upper_limb\Spine\analysis\', subName{1}(1:5), '\Spine_voxel_dv_z', num2str(zScore), '.svg']);

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% zscore
%%%%% 1v 2d  1 l 2 r
figure;
hBar = bar([mean(zlrSeg4, 'omitnan'), mean(zlrSeg6, 'omitnan')], 'FaceColor', 'flat');
X = get(hBar,'XData').'+[hBar.XOffset];
hold on  %4 runs
hEB = errorbar(X, [mean(zlrSeg4, 'omitnan'), mean(zlrSeg6, 'omitnan')], [(std(zlrSeg4, 'omitnan')/sqrt(length(zlrSeg4))), (std(zlrSeg6, 'omitnan')/sqrt(length(zlrSeg4)))], 'vertical','.', 'Color', 'black', 'Marker', 'none');  % add the errorbar
randVec = (-1 + (1+1)*rand(2,1))/12;
scatter([randVec+X(1,1), randVec+X(2,1), randVec+X(3,1), randVec+X(4,1)], [zlrSeg4, zlrSeg6],  30, 'k','o','filled'); 
xticks(1:4); xticklabels({'L(pre)', 'R(pre)', 'L(post)', 'R(post)'})
xlabel('Cervical Area')
ylabel('Z-score');
title(sprintf('Average Z-score Pre vs Post'));
...
saveas(gcf, ['D:\SMA\MRI_data_upper_limb\Spine\analysis\', subName{1}(1:5), '\Spine_zscore_lr_z', num2str(zScore), '.png']);
saveas(gcf, ['D:\SMA\MRI_data_upper_limb\Spine\analysis\', subName{1}(1:5), '\Spine_zscore_lr_z', num2str(zScore), '.svg']);
% [ci95, rejectNull, diffSampMeans] = bootstrapCompMeans(zPre2, zPost2, 10000, 0.001);

figure;
hBar = bar([mean(zdvSeg4, 'omitnan'), mean(zdvSeg6, 'omitnan')], 'FaceColor', 'flat');
X = get(hBar,'XData').'+[hBar.XOffset];
hold on  %4 runs
hEB = errorbar(X, [mean(zdvSeg4, 'omitnan'), mean(zdvSeg6, 'omitnan')], [(std(zdvSeg4, 'omitnan')/sqrt(length(zdvSeg4))) , (std(zdvSeg6, 'omitnan')/sqrt(length(zdvSeg6)))], 'vertical','.', 'Color', 'black', 'Marker', 'none');  % add the errorbar
randVec = (-1 + (1+1)*rand(2,1))/12;
scatter([randVec+X(1,1), randVec+X(2,1), randVec+X(3,1), randVec+X(4,1)], [zdvSeg4, zdvSeg6],  30, 'k','o','filled'); 
% scatter([randVec+X(2,1), randVec+X(2,2), randVec+X(2,3), randVec+X(2,4)], [zdvSeg4, zdvSeg6],   30, 'k','o','filled'); 
xticks(1:4); xticklabels({'V(pre)', 'D(pre)', 'V(post)', 'D(post)'})
xlabel('Cervical Area')
ylabel('Z-score');
title(sprintf('Average Z-score Pre vs Post'));
...
saveas(gcf, ['D:\SMA\MRI_data_upper_limb\Spine\analysis\', subName{1}(1:5), '\Spine_zscore_dv_z', num2str(zScore), '.png']);
saveas(gcf, ['D:\SMA\MRI_data_upper_limb\Spine\analysis\', subName{1}(1:5), '\Spine_zscore_dv_z', num2str(zScore), '.svg']);
% %% template matching
% clear all
% 
% %%% SPINE
...
% %%THINGS TO ADD
% 
% gunzip('D:\SMA\MRI_data_upper_limb\Spine\template\PAM50_levels.nii.gz');
% [spineLevels, ~] = cbiReadNifti('D:\SMA\MRI_data_upper_limb\Spine\template\PAM50_levels.nii');
% spineLevels(spineLevels < 5) = 0;
% spineLevels(spineLevels > 8) = 0;
% spineLevels(spineLevels > 0) = spineLevels(spineLevels > 0) - 4;
% 
...
% 
% % Save the plot as a PNG image
% % saveas(gcf, ['D:\SMA\MRI_data_upper_limb\Spine\analysis\', subName{1}(1:5), Spine_voxel_control.png');
% % saveas(gcf, ['D:\SMA\MRI_data_upper_limb\Spine\analysis\', subName{1}(1:5), Spine_voxel_control.svg');
% 
...
% 
% % Save the plot as a PNG image
% % saveas(gcf, ['D:\SMA\MRI_data_upper_limb\Spine\analysis\', subName{1}(1:5), Spine_zscore_control.png');
% % saveas(gcf, ['D:\SMA\MRI_data_upper_limb\Spine\analysis\', subName{1}(1:5), Spine_zscore_control.svg');
% 
...
% 
% % Save the plot as a PNG image
% % saveas(gcf, ['D:\SMA\MRI_data_upper_limb\Spine\analysis\', subName{1}(1:5), Spine_active_control_all.png');
% % saveas(gcf, ['D:\SMA\MRI_data_upper_limb\Spine\analysis\', subName{1}(1:5), Spine_active_control_all.svg');
% 
...
% 
% % Save the plot as a PNG image
% % saveas(gcf, ['D:\SMA\MRI_data_upper_limb\Spine\analysis\', subName{1}(1:5), Spine_zscore_control_all.png');
% % saveas(gcf, ['D:\SMA\MRI_data_upper_limb\Spine\analysis\', subName{1}(1:5), Spine_zscore_control_all.svg');
