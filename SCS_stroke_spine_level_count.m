...
saveas(gcf, ['D:\SBSN\stroke\SCS\Spine_tsnr.png']);
saveas(gcf, ['D:\SBSN\stroke\SCS\Spine_tsnr.svg']);
...
% Save the plot as a PNG image
saveas(gcf, ['D:\SBSN\stroke\SCS\Spine_voxel_success_z', num2str(zScore), '.png']);
saveas(gcf, ['D:\SBSN\stroke\SCS\Spine_voxel_success_z', num2str(zScore), '.svg']);
...
% Save the plot as a PNG image
% saveas(gcf, ['D:\SBSN\Data\Spine\analysis\', subName{1}(1:5), Spine_voxel_diff.png');
% saveas(gcf, ['D:\SBSN\Data\Spine\analysis\', subName{1}(1:5), Spine_voxel_diff.svg');
...
saveas(gcf, ['D:\SBSN\stroke\SCS\Spine_zscore_success_z', num2str(zScore), '.png']);
saveas(gcf, ['D:\SBSN\stroke\SCS\Spine_zscore_success_z', num2str(zScore), '.svg']);
...
% 
% % Save the plot as a PNG image
% saveas(gcf, ['D:\SBSN\Data\Spine\analysis\', subName{1}(1:5), Spine_zscore_diff.png');
% saveas(gcf, ['D:\SBSN\Data\Spine\analysis\', subName{1}(1:5), Spine_zscore_diff.svg');
...
% % Save the plot as a PNG image
% % saveas(gcf, ['D:\SBSN\Data\Spine\analysis\', subName{1}(1:5), Spine_voxel_slope.png');
% % saveas(gcf, ['D:\SBSN\Data\Spine\analysis\', subName{1}(1:5), Spine_voxel_slope.svg');
% 
% 
% 
% time = [1, 2, 3, 4, 5];
...
% xticklabels({'1-2','1-3','1-4','1-5','1-6'})
% Save the plot as a PNG image
% saveas(gcf, ['D:\SBSN\Data\Spine\analysis\', subName{1}(1:5), Spine_zscore_slope.png');
% saveas(gcf, ['D:\SBSN\Data\Spine\analysis\', subName{1}(1:5), Spine_zscore_slope.svg');
...
% Save the plot as a PNG image
saveas(gcf, ['D:\SBSN\stroke\SCS\Spine_voxel_area_z', num2str(zScore), '.png']);
saveas(gcf, ['D:\SBSN\stroke\SCS\Spine_voxel_area_z', num2str(zScore), '.svg']);
...
% Save the plot as a PNG image
saveas(gcf, ['D:\SBSN\stroke\SCS\Spine_zscore_area_z', num2str(zScore), '.png']);
saveas(gcf, ['D:\SBSN\stroke\SCS\Spine_zscore_area_z', num2str(zScore), '.svg']);
...
saveas(gcf, ['D:\SBSN\stroke\SCS\Spine_voxel_lr_z', num2str(zScore), '.png']);
saveas(gcf, ['D:\SBSN\stroke\SCS\Spine_voxel_lr_z', num2str(zScore), '.svg']);
...
% Save the plot as a PNG image
saveas(gcf, ['D:\SBSN\stroke\SCS\Spine_voxel_dv_z', num2str(zScore), '.png']);
saveas(gcf, ['D:\SBSN\stroke\SCS\Spine_voxel_dv_z', num2str(zScore), '.svg']);
...
% Save the plot as a PNG image
saveas(gcf, ['D:\SBSN\stroke\SCS\Spine_zscore_lr_z', num2str(zScore), '.png']);
saveas(gcf, ['D:\SBSN\stroke\SCS\Spine_zscore_lr_z', num2str(zScore), '.svg']);
...
saveas(gcf, ['D:\SBSN\stroke\SCS\Spine_zscore_dv_z', num2str(zScore), '.png']);
saveas(gcf, ['D:\SBSN\stroke\SCS\Spine_zscore_dv_z', num2str(zScore), '.svg']);
%% template matching
% clear all
% 
% %%% SPINE
...
% 
% % Save the plot as a PNG image
% % saveas(gcf, ['D:\SBSN\Data\Spine\analysis\', subName{1}(1:5), Spine_voxel_control.png');
% % saveas(gcf, ['D:\SBSN\Data\Spine\analysis\', subName{1}(1:5), Spine_voxel_control.svg');
% 
...
% 
% % Save the plot as a PNG image
% % saveas(gcf, ['D:\SBSN\Data\Spine\analysis\', subName{1}(1:5), Spine_zscore_control.png');
% % saveas(gcf, ['D:\SBSN\Data\Spine\analysis\', subName{1}(1:5), Spine_zscore_control.svg');
% 
...
% 
% % Save the plot as a PNG image
% % saveas(gcf, ['D:\SBSN\Data\Spine\analysis\', subName{1}(1:5), Spine_active_control_all.png');
% % saveas(gcf, ['D:\SBSN\Data\Spine\analysis\', subName{1}(1:5), Spine_active_control_all.svg');
% 
...
% 
% % Save the plot as a PNG image
% % saveas(gcf, ['D:\SBSN\Data\Spine\analysis\', subName{1}(1:5), Spine_zscore_control_all.png');
% % saveas(gcf, ['D:\SBSN\Data\Spine\analysis\', subName{1}(1:5), Spine_zscore_control_all.svg');
