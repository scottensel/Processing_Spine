...
tput setaf 6; 
echo -n "Enter the index of the step to perform (1 = Prepare for GLM, 2 = Prepare for GLM forces, 3 = Prepare for GLM smooth forces, 4 = Prepare for iCAP): "
tput sgr0;
read ind
...
for s in "${sub[@]}"; do
        ...
        for d in "${myFunc[@]}"; do
            ...
            for i in "../../../template/"$templateFile; do
                ...
                # I DONT NEED THIS SECTION ANYMORE
                # 2 - GENERATE EVS
                elif [ "$ind" == "5" ]; then
